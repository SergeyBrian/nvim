...
require("lazy").setup({
...

    {
        ...
        config = function()
            ...
            lspconfig.clangd.setup({
                ...
                init_options = {
                    cmd = {
                        ...
                        "--extra-arg=-IC:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.41.34120\\include",
                        "--extra-arg=-IC:\\Program Files (x86)\\Windows Kits\\10\\Include\\10.0.26100.0\\um",
                    },
            ...
            --             project = {
            --                 referencedLibraries = {
            --                     '/Users/sergey/tmp/andrejdemidovmazesolverprogram/lib/MazeHelper.jar',
            --                 }
            --             }
            --         }
            --     }
